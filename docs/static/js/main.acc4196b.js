/*! For license information please see main.acc4196b.js.LICENSE.txt */
!(function () {
	var e = {
			757: function (e, t, n) {
				e.exports = n(727);
			...
			463: function (e, t, n) {
				...
				function zr(e, t, n, r) {
					...
					l.has(i) || (t && (o |= 4), Rr(a, e, o, t), l.add(i));
				}
				function Rr(e, t, n, r) {
					var o = zt.get(t);
					switch (void 0 === o ? 2 : o) {
				...
				function Dr(e, t) {
					for (var n = t + 'Capture', r = []; null !== e; ) {
						...
						5 === o.tag &&
							null !== a &&
							((o = a),
							null != (a = Ae(e, n)) && r.unshift(Mr(e, a, o)),
							null != (a = Ae(e, t)) && r.push(Mr(e, a, o))),
							(e = e.return);
					}
					return r;
				}
				...
				function Ur(e, t, n, r, o) {
					for (var a = t._reactName, l = []; null !== n && n !== r; ) {
						...
						5 === i.tag &&
							...
							((i = s),
							o
								? null != (u = Ae(n, a)) && l.unshift(Mr(n, u, i))
								: o || (null != (u = Ae(n, a)) && l.push(Mr(n, u, i)))),
							(n = n.return);
					}
				...
				function Xo() {
					if (!Vo && null !== Ao) {
						...
						try {
							...
							throw (null !== Ao && (Ao = Ao.slice(e + 1)), No(zo, Yo), n);
						} finally {
							Vo = !1;
						}
					}
				...
				function Ra(e, t) {
					switch ((fo(ja, t), fo(La, e), fo(Ta, Oa), (e = t.nodeType))) {
						case 9:
						case 11:
				...
				function qa(e) {
					...
					} else Ba = Aa ? Kr(e.stateNode.nextSibling) : null;
					return !0;
				}
				function Ka() {
					(Ba = Aa = null), (Va = !1);
				...
				function il(e, t, n, r, o, a) {
					if (
						...
						(t.updateQueue = null),
						(t.lanes = 0),
						(Ga.current = null === e || null === e.memoizedState ? zl : Rl),
						(e = n(r, o)),
						ol)
					) {
						a = 0;
				...
				function ii(e, t, n) {
					...
					switch (t.tag) {
						...
						case 4:
							return Ia(), null === e && jr(t.stateNode.containerInfo), null;
						case 10:
							return oa(t), null;
						case 19:
				...
				function ui(e) {
					switch (e.tag) {
						...
						case 3:
							if ((Ia(), co(mo), co(ho), Xa(), 0 !== (64 & (t = e.flags))))
								throw Error(l(285));
				...
				function _i(e, t) {
					switch (t.tag) {
						...
						case 13:
							return (
								null !== t.memoizedState && ((Wi = Ho()), gi(t.child, !0)),
								void Ni(t)
							);
						case 19:
							return void Ni(t);
				...
				var Ki,
					...
					fu = !1;
				function du() {
					return 0 !== (48 & ji) ? Ho() : -1 !== iu ? iu : (iu = Ho());
				}
				function pu(e) {
					if (0 === (2 & (e = e.mode))) return 1;
					if (0 === (4 & e)) return 99 === Wo() ? 1 : 2;
					if ((0 === uu && (uu = Ai), 0 !== Go.transition)) {
				...
				function hu(e, t, n) {
					...
					$t(e, t, n), e === zi && ((Vi |= t), 4 === Fi && gu(e, Ii));
					var r = Wo();
					1 === t
						? 0 !== (8 & ji) && 0 === (48 & ji)
							? bu(e)
				...
				function vu(e, t) {
					...
					if (((r = Ft(e, e === zi ? Ii : 0)), (t = Mt), 0 === r))
						...
						15 === t
							? ((n = bu.bind(null, e)),
							  null === Ao ? ((Ao = [n]), (Bo = No(zo, Xo))) : Ao.push(n),
							  (n = Fo))
							: 14 === t
				...
				function yu(e) {
					...
					if (
						...
						if (
							...
							throw ((t = Ui), Su(e, 0), gu(e, n), vu(e, Ho()), t);
						switch (
							...
							case 3:
								if (
									(gu(e, n), (62914560 & n) === n && 10 < (r = Wi + 500 - Ho()))
								) {
									if (0 !== Ft(e, 0)) break;
				...
				function bu(e) {
					...
					if (
						...
						throw ((n = Ui), Su(e, 0), gu(e, t), vu(e, Ho()), n);
					return (
				...
				function Nu(e, t) {
					...
					if ((ra(), (ji = n), (Ti.current = r), null !== Ri))
						throw Error(l(261));
					return (zi = null), (Ii = 0), Fi;
				}
				function Pu() {
					for (; null !== Ri; ) Tu(Ri);
				}
				function Ou() {
					for (; null !== Ri && !Oo(); ) Tu(Ri);
				}
				function Tu(e) {
				...
				function Lu(e) {
					...
					do {
						...
						if (((e = t.return), 0 === (2048 & t.flags))) {
							if (null !== (n = ii(n, t, Mi))) return void (Ri = n);
							if (
								(24 !== (n = t).tag && 23 !== n.tag) ||
								null === n.memoizedState ||
								0 !== (1073741824 & Mi) ||
				...
				function qu(e, t, n, r, o, a) {
					...
					if (((r = e), 'function' === typeof e)) Wu(e) && (i = 1);
						...
						e: switch (e) {
							...
							case L:
								return (
									((e = Hu(19, n, t, o)).elementType = L), (e.lanes = a), e
								);
							case D:
								return Yu(n, o, a, t);
							case F:
				...
				(Ki = function (e, t, n) {
					var r = t.lanes;
					if (null !== e)
						if (e.memoizedProps !== t.pendingProps || mo.current) Dl = !0;
						else {
							if (0 === (n & r)) {
								switch (((Dl = !1), t.tag)) {
									case 3:
					...
					switch (((t.lanes = 0), t.tag)) {
						...
						case 4:
							return (
								Ra(t, t.stateNode.containerInfo),
								(r = t.pendingProps),
								null === e ? (t.child = Na(t, null, r, n)) : Fl(e, t, r, n),
								t.child
							);
						case 11:
							return (
								(r = t.type),
								(o = t.pendingProps),
								Ul(e, t, r, (o = t.elementType === r ? o : Jo(r, o)), n)
							);
						case 7:
						...
						case 10:
							e: {
								...
								if (
									(fo(Zo, u._currentValue), (u._currentValue = a), null !== i)
								)
									if (
										((u = i.value),
										0 ===
				...
				var us = { Events: [ro, oo, ao, Le, je, Iu, { current: !1 }] },
					ss = {
				...
				function R(e) {
					for (var t = E(N); null !== t; ) {
						if (null === t.callback) S(N);
							...
							S(N), (t.sortIndex = t.expirationTime), x(_, t);
						}
						t = E(N);
					}
				}
							...
							l > i
								? ((e.sortIndex = l),
								  ...
								  null === E(_) &&
										e === E(N) &&
										(z ? o() : (z = !0), r(I, l - i)))
								: ((e.sortIndex = u), x(_, e), j || L || ((j = !0), n(M))),
							e
						);
					}),
	...
	(n.n = function (e) {
		...
		(function () {
			...
			var d = function (t) {
					var n = t.todo,
						r = t.onChecked,
						o = l((0, e.useState)(n.isChecked), 2),
						a = o[0],
						i = o[1];
					(0, e.useEffect)(
						function () {
					...
					var u = c()('todo-item mb-2 p-2 cursor-pointer', {
							'bg-orange-50': n.completed,
							'bg-slate-100': a,
							'hover:bg-slate-50': !a,
						}),
						s = '';
					return (
						n.description &&
							(s = (0, f.jsx)('div', {
								className: 'todo-item__text text-slate-400',
						...
						(0, f.jsxs)('div', {
							...
							onClick: function () {
								return (
									(e = { todoItemId: n.id, isChecked: !a }), i(!a), void r(e)
								);
								var e;
							},
							children: [
								...
								(0, f.jsx)('div', {
									className: 'todo-item__title font-medium text-xl',
									children: n.name,
								}),
								s,
							],
			...
			var b = function (e) {
				var t = e.children,
					n = y(e, g),
					r = 'hover:opacity-80 px-3 py-1.5 '.concat(n.className);
				return (
					delete n.className,
					(0, f.jsx)(
						'button',
						v(v({ type: 'button', className: r }, n), {}, { children: t }),
					)
				);
			};
			var w = function (t) {
				var n = t.selectedTasks,
					r = (0, e.useContext)(p),
					o = r.deleteTodoItem,
					a = r.completeTodoItem,
					l = r.onEdit,
					i = n.length,
					u = 'Delete all '.concat(i, ' tasks'),
					s = 'Complete all '.concat(i, ' tasks'),
					c = '',
					d = '';
				return (
					1 === i &&
						...
						(d = (0, f.jsx)(b, {
							...
							title: s,
							onClick: a.bind(),
							children: n[0].completed ? 'Incomplete' : 'Complete',
						}))),
					(0, f.jsxs)('div', {
						className: 'p-2 border-b border-slate-100 mb-2 flex',
						children: [
							(0, f.jsxs)('span', {
								children: ['Selected ', i, ' ', i > 1 ? 'tasks' : 'task'],
							}),
							(0, f.jsxs)('div', {
			...
			var k = function (t) {
				...
				return (0, f.jsxs)(f.Fragment, {
					children: [
						l,
						o.length ? (0, f.jsx)(w, { selectedTasks: o }) : '',
						(0, f.jsx)('div', {
							className: 'todo-list overflow-y-auto max-h-96',
							children: n.map(function (e) {
								return (0, f.jsx)(d, { todo: e, onChecked: r }, e.id);
							}),
						}),
					],
				});
			...
			var x = function (e) {
					...
					return (0, f.jsx)(b, {
						className:
							'fixed bottom-3 right-3 rounded-full bg-blue-500 hover:bg-blue-600 transition-colors w-10 h-10 text-white text-2xl',
						title: 'Create a task',
						onClick: t,
				...
				C = function (e) {
					var t = e.url,
						...
						s = e.headers,
						c = void 0 === s ? {} : s;
					return S()({ url: n, method: o, params: l, data: u, headers: c });
				},
				_ = function (e) {
					return C({
				...
				N = function (e, t) {
					return C({
						url: 'https://my-json-server.typicode.com/savayer/demo/todos/'.concat(
							e,
						),
						method: 'PUT',
						data: t,
					...
					v(
						...
						{},
						{
							children: (0, f.jsxs)('div', {
								...
								children: [(0, f.jsx)('div', {}), (0, f.jsx)('div', {})],
							}),
						},
					),
				);
			...
			var T = function (e) {
				var t = e.children,
					n = e.onClose;
				return (0, f.jsx)('div', {
					className: 'overlay fixed z-10 inset-0 flex bg-black/75',
					children: (0, f.jsxs)('div', {
						className:
							'modal m-auto w-11/12 sm:w-1/2 xl:w-1/4 p-5 bg-white rounded-md relative',
						children: [
							(0, f.jsx)('svg', {
								...
								children: (0, f.jsx)('use', { xlinkHref: '#close' }),
							}),
							t,
						],
					}),
			...
			function L(t) {
				var n = t.formTitle,
					r = t.onClose,
					o = t.onSubmit,
					a = t.submitButtonText,
					i = t.todoItemForEditing,
					u = l((0, e.useState)(i.name || ''), 2),
					s = u[0],
					c = u[1],
					d = l((0, e.useState)(!1), 2),
					p = d[0],
					h = d[1],
					m = l((0, e.useState)(i.description || ''), 2),
					v = m[0],
					y = m[1];
				return (0, f.jsx)(T, {
					onClose: r,
					children: (0, f.jsxs)('div', {
						className: 'p-3 text-right text-black',
						children: [
							(0, f.jsx)('div', {
								className: 'text-3xl text-left mb-3',
								children: n,
							}),
							(0, f.jsx)('input', {
								type: 'text',
								...
								className:
									'border border-slate-300 w-full h-8 focus:outline-none p-2 '.concat(
										p ? 'border-red-500' : '',
									),
							}),
							(0, f.jsx)('textarea', {
								...
								value: v,
								className:
									'border border-slate-300 w-full mt-2 min-h-10 max-h-24 focus:outline-none p-2',
							}),
							(0, f.jsx)(b, {
			...
			L.defaultProps = {
				...
				todoItemForEditing: { name: '', description: '' },
			};
			var j = L,
				z = { title: 'Creating todo', button: 'Create Todo', isUpdating: !1 },
				R = { title: 'Updating todo', button: 'Update Todo', isUpdating: !0 };
			var I = function () {
				var t = l((0, e.useState)(z), 2),
					n = t[0],
					r = t[1],
									...
									function (e) {
										for (;;)
											switch ((e.prev = e.next)) {
												...
												case 4:
													(t = e.sent), (n = t.data), w(n), (e.next = 12);
													break;
												case 9:
													(e.prev = 9),
														(e.t0 = e.catch(0)),
							...
							return u().wrap(
								function (e) {
									for (;;)
										switch ((e.prev = e.next)) {
											case 0:
												return (e.prev = 0), h(!1), s(!0), (e.next = 5), _(t);
											case 5:
												(n = e.sent),
													(r = n.data),
													w(b.concat([r])),
								...
								function (e) {
									for (;;)
										switch ((e.prev = e.next)) {
											case 0:
												return (
													(e.prev = 0), h(!1), s(!0), (e.next = 5), N(t.id, t)
												);
											case 5:
												(n = e.sent),
													(r = n.data),
				...
				return (
					...
					(0, f.jsxs)(p.Provider, {
							...
							completeTodoItem: function () {
								w(
									b.map(function (e) {
										return (
											e.isChecked &&
												((e.completed = !e.completed), (e.isChecked = !1)),
											e
										);
									}),
								);
						...
						children: [
							(0, f.jsx)('div', {
								className:
									'app bg-white rounded-lg drop-shadow-xl p-3 relative',
								children: i
									? (0, f.jsx)(O, { className: 'text-center' })
									: (0, f.jsx)(k, {
											todos: b,
											selectedTodos: b.filter(function (e) {
												return e.isChecked;
											}),
											onSelectTodo: function (e) {
												w(
													b.map(function (t) {
														return (
															t.id === e.todoItemId &&
							...
							d
								? (0, f.jsx)(j, {
										isShowModal: d,
										todoItemForEditing: v,
										formTitle: n.title,
										submitButtonText: n.button,
										onSubmit: n.isUpdating
											? function (e) {
			...
			t.render(
				(0, f.jsx)(e.StrictMode, { children: (0, f.jsx)(I, {}) }),
				document.getElementById('root'),
			);
		})();
})();
//# sourceMappingURL=main.acc4196b.js.map
